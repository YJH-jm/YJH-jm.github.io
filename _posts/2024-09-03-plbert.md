...
<summary>자세히</summary>
	<div markdown="1">
       <br>
       각 sequence에서 15%의 grapheme에 해당되는 phoneme들이 랜덤으로 마스킹 <br>
       Graphem 가 선택되면 phoneme token은 80% time (확률인가...?) MSK token 으로 대체 <br>
       10%의 time으로 랜덤한 phoneme token으로 대체 <br>
       10%의 time으로 변경되지 않음<br>
    </div>
</details>
